...
import pandas as pd
import numpy as np
cars=pd.read_csv("D:/18-Linear Regression/Cars.csv")
...
#it means it is gretaer than 0.05 ,WT and VOL columns #
#we need to ignore
#or delete instead of deleting 81 entries
#row wise outliers
#identifying is there any influential va;ue
...
#Residual plots are used to check whether the error are independent 

#Let us plot the influential plot 
sm.graphics.influence_plot(final_ml)
#we have taken cars instead cars_newdata,hence 76 is reflected
#again in influential data
